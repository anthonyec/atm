...
exports.parseDataResponse = function(xml, fields = []) {
  ...
  if (!datasetItem['ns3:Value'] || !datasetItem['ns3:Value'][0]) {
    throw new TypeError('XML is missing "ns3:Value" element');
  }
